...
class InsufficientCreditsException extends Exception
{
    ...
    {
        return sprintf(
            '[insufficient_credits] Need %d credit%s; %d remaining this period. Call get_billing, then create_checkout so the human can open Paddle Checkout for Pro ($9/mo, 100 credits).',
            $this->required,
            $this->required === 1 ? '' : 's',
            $this->remaining,
        );
