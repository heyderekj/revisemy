...
#[Description('Start Stripe Checkout for Pro ($9/mo, 100 credits, full quality). Returns checkout_url — open it for the human (or share the link). After they pay, continue with create_review. Prefer this when create_review returns [insufficient_credits].')]
class CreateCheckoutTool extends Tool
{
    ...
    public function handle(Request $request): Response|ResponseFactory
    {
        ...
        return Response::make(Response::text(
            "Open this Stripe Checkout link for the human to upgrade to Pro:\n{$url}\n\n".
