...
{
    public const CACHE_BUST = '7';

    public const APP_ICON = 'images/app-icon.png?v='.self::CACHE_BUST;

    public const FAVICON_32 = 'images/favicon-32x32.png?v='.self::CACHE_BUST;

    public const APPLE_TOUCH = 'images/apple-touch-icon.png?v='.self::CACHE_BUST;
}
