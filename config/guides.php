        ...
        'connectors' => [
            ...
            'hosts' => [
                ...
                [
                    ...
                    'body' => 'Claude Desktop can render the review inline via MCP Apps. Use Settings → Developer → Edit Config with the mcp-remote JSON (Bearer try tokens do not fit Connectors → Add custom connector, which is OAuth-oriented). Claude Code is CLI-only and shares a `review_url` instead.',
                    'steps' => [
