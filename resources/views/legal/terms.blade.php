<x-layouts.app
    ...
    description="Terms of use for ReviseMy — open-source MIT software, try tokens, review links, and no warranty. Product-truth draft — not formal legal counsel."
                ...
                <div class="mt-10 space-y-8 text-[15px] leading-relaxed text-zinc-600">
                    <section>
                        ...
                        <p class="mt-3">
                            ...
                            <a href="https://github.com/heyderekj/revisemy/blob/main/LICENSE" class="font-medium text-rose-600 underline decoration-rose-600/30 underline-offset-2 transition hover:text-rose-700" target="_blank" rel="noreferrer">MIT License</a>.
                            That license governs the code. These terms describe how the hosted demo / try-token experience is intended to be used.
                        </p>
                    </section>
