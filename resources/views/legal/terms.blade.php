        ...
        <x-home-section>
            <div class="space-y-8 text-[15px] leading-relaxed text-zinc-600">
                ...
                <section>
                    ...
                    <p class="mt-3">
                            Homepage try tokens create a Free workspace so agents can call MCP and REST. Each workspace receives a monthly credit grant (Free and Plus use the same full capture quality; Plus adds a larger grant via Paddle Checkout). Creating a review spends credits by source (images/PDF, email HTML, or URL capture). Rate limits, retention, and expiry may apply (including guest-link and review lifetimes described in product docs). Unused credits do not roll over. Paddle is the merchant of record for paid plans.
                    </p>
                </section>
