...
<body class="min-h-dvh bg-zinc-50 text-zinc-900 antialiased">
    <main class="mx-auto flex min-h-dvh max-w-lg flex-col justify-center px-6 py-16">
        ...
        <p class="mt-3 text-base leading-relaxed text-zinc-600">
            Thanks{{ $email ? ' — receipt goes to '.$email : '' }}.
        ...
        <p class="mt-6 text-base leading-relaxed text-zinc-600">
            Return to your agent and continue the checkup — call <code class="rounded bg-zinc-200/80 px-1.5 py-0.5 text-sm">create_review</code> again, or <code class="rounded bg-zinc-200/80 px-1.5 py-0.5 text-sm">get_billing</code> to confirm credits.
        </p>
